...
<body class="bodyLogin">
  ...
  <img src="./assets/thiago-removebg.png" alt="Fundo laranja" id="atorLogin">
  <div class="loader">
    <img src="./assets/0099.png" alt="Moeda" id="moedaFrente" class="imagem-giratoria"> 
  </div>

  <section id="sectionLogin">
    
    <div class="imgLogin">
      <img src="./assets/logo_branca (1).png" alt="..." id="img-login">
    </div>
